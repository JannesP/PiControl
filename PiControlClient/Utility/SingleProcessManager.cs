...
{
    public class SingleProcessManager : IDisposable
    {
        ...
        public SingleProcessManager(string systemUniqueIdentifierName, bool notifyIfNotFirst = true)
        {
        ...
        public void Dispose()
        {
            _evtNotifiedFromOtherProcess?.SafeDispose();
            if (IsFirstInstance)
            {
                try
                {
            ...
            _mutexCheckIfFirstInstance.SafeDispose();
